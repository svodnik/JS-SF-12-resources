...
// * STEP 2
// Write a statement to create the text node for the h3 element, using the text 
// "About Us", then write statements to create the text nodes for the two p 
...
// * STEP 3
// Write a statement to attach the heading text node as a child of the heading 
// element, then write statements to attach the heading text node for each 
// paragraph as a child of the relevant paragraph element.
