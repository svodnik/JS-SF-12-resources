/*
    1. Sign up for openweathermap.org and generate an API key, then store that
       value in the js/keys.js file in the apiKey variable.
    2. In this file (main.js), write code using either $.ajax or $.get to pull
    ...
    5. Use DOM manipulation to add the returned temperature to the span element
       with the id 'temp'.
    6. Sign up for developer.weatherunlocked.com and obtain your application ID
